...
function BritishInjection(){
	...
	ChartNames = ["British Breakdown Of Tweets", "British Breakdown Of Tweets w/ Sentiment"]
...
function GetManys(){
	hashtag = $("#inputPlaceholderEx").val()
	amount = $("#AmountOfTweets").val()
	$.ajax({
			  type:'get',
			  url:'http://localhost:5000/Hashtag/' + hashtag + "/" + amount,
			  cache:false,
			  async:'asynchronous',
			  dataType:'text',
			  success: function(data) {
